		...
		<c:if test="${role eq 'admin'}">
			...
			<tr>
				<td valign="top">
					<table border="0" cellspacing="0" cellpadding="0" width="159">
						<tr>
							<td class="Depth03"><a href="/addProductView.do"
						...
						<tr>
							<td class="Depth03"><a href="/listSale.do?menu=sale"
								target="rightFrame">상품배송관리</a></td>
						</tr>
						<tr>
							<td class="DepthEnd">&nbsp;</td>
						</tr>
			...
			<td valign="top">
				<table border="0" cellspacing="0" cellpadding="0" width="159">
					...
					<c:if test="${!empty user && role eq 'user'}">
						<tr>
							<td class="Depth03"><a href="/listPurchase.do?menu=purchase"
